...
import com.example.myworld.viewmodel.CategoryItemViewHolder

class CategoryItemAdapter(private val context: Context, private val categoryItem:List<CategoryItem>, private val pos: Int) : RecyclerView.Adapter<CategoryItemViewHolder>()
{
