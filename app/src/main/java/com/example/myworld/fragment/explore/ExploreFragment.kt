...
class SearchFragment : Fragment()
{
    ...
    override fun onStart()
    {
        ...
        categoryItemList5.add(CategoryItem(2, "category1"))
        categoryItemList5.add(CategoryItem(2, "category2"))
        categoryItemList5.add(CategoryItem(2, "category3"))
        categoryItemList5.add(CategoryItem(2, "category4"))
        categoryItemList5.add(CategoryItem(2, "category5"))

        val categoryItemList6: MutableList<CategoryItem> = ArrayList()
        categoryItemList6.add(CategoryItem(2, "category1"))
        categoryItemList6.add(CategoryItem(2, "category2"))
        categoryItemList6.add(CategoryItem(2, "category3"))
        categoryItemList6.add(CategoryItem(2, "category4"))
        categoryItemList6.add(CategoryItem(2, "category5"))

        val categoryItemList7: MutableList<CategoryItem> = ArrayList()
        categoryItemList7.add(CategoryItem(2, "category1"))
        categoryItemList7.add(CategoryItem(2, "category2"))
        categoryItemList7.add(CategoryItem(2, "category3"))
        categoryItemList7.add(CategoryItem(2, "category4"))
        categoryItemList7.add(CategoryItem(2, "category5"))

        val categoryItemList8: MutableList<CategoryItem> = ArrayList()
        categoryItemList8.add(CategoryItem(2, "category1"))
        categoryItemList8.add(CategoryItem(2, "category2"))
        categoryItemList8.add(CategoryItem(2, "category3"))
        categoryItemList8.add(CategoryItem(2, "category4"))
        categoryItemList8.add(CategoryItem(2, "category5"))

        val categoryItemList9: MutableList<CategoryItem> = ArrayList()
        categoryItemList9.add(CategoryItem(2, "category1"))
        categoryItemList9.add(CategoryItem(2, "category2"))
        categoryItemList9.add(CategoryItem(2, "category3"))
        categoryItemList9.add(CategoryItem(2, "category4"))
        categoryItemList9.add(CategoryItem(2, "category5"))

        val categoryItemList10: MutableList<CategoryItem> = ArrayList()
        categoryItemList10.add(CategoryItem(2, "category1"))
        categoryItemList10.add(CategoryItem(2, "category2"))
        categoryItemList10.add(CategoryItem(2, "category3"))
        categoryItemList10.add(CategoryItem(2, "category4"))
        categoryItemList10.add(CategoryItem(2, "category5"))
